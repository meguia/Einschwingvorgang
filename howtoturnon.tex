...
\begin{lstlisting}[frame=single,caption=Compensated oscillation.]
...
\begin{lstlisting}[frame=single,caption=Exploring the sound of homoclinic bifurcation.]
...
(
Ndef(\homoclinic, { |mu = 0.17, delta = 0.5|
	var ps = Fb1_ODE.ar(\homoclinic, [mu, delta], y0: [0, 0], tMul: 80, leakDC: false);
