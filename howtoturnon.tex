...
\begin{figure}
    ...
    \caption{Phase space representation of four states (1-4) of the ideal harmonic oscillator without dissipation (center) portrayed as a spring-mass system in the left, and time evolution of the $x$ variable for the case with friction (blue trajectory in the phase space)} 
    \label{fig_harmosc}
\end{figure}
