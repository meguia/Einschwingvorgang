...
using  Symbolics, PlutoPlotly, LinearAlgebra, PlutoUI
...
begin
	go1 = parametric_curve(f,0,2*pi,300,0:pi/3:2*pi;scale=5.0)
	p1 = Plot(go1,Layout(width = 800,height= 800))
	PlutoPlot(p1)
end	
...
manifest_format = "2.0"
project_hash = "246c9fe40b724fdbdde2dbea95b376db2bd9a552"
